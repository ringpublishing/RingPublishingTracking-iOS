...
// Helper class for user agent used in RingPublishingTracking network requests
class UserAgent {

    /// Returns default User Agent which should be used across all requestsused by RingPublishingTracking
    static var RingPublishingTrackingUserAgent: String {
